...
export function Scores() {
  ...
  return (
    <main>
      <div id="picture" className="picture-box"><img width="200px" src="https://c-cl.cdn.smule.com/rs-s25/arr/ee/69/0d745ba6-9251-47d7-b548-7ba9e92a9210.jpg" alt="random" /></div>
      <div className='general_text'>Number of times teeth you have brushed your teeth</div>
      <div className='general_text' id="totalWins">{score}</div>
    </main>
  );
}
